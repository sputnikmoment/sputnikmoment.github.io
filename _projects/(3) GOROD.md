...
В связи нежеланием клиента вести учет статистики поставленные задачи не имеют для меня измеримых результатов. Потому расскажу о средствах достижения.
...
Поскольку клиент так же отказался и от персонифицированного продвижения специалистов, выбран вариант "корпоративный блог" + "развлекательный блог". 
⠀
...
Помимо этого я подготавливал сторис и полностью отвечал за визуальное оформление постов, а так же занимался репостом текстов в учетные записи в других соцсетях и настраивал таргет-рекламу услуг компании.
⠀
